		...
		<div class="row clearfix">
			...
			<div class="container-fluid">
				<div class="navbar-header">
					<h4 class="friendsPanelFont">Suggested Friends On Basis Of
						Mutual Friends Count</h4>
				</div>
			</div>
			</nav>
		</div>
		...
		<div class="row" id="friendsTiles">
			...
			<s:iterator value="friends" status="stat">
				<div class="col-md-12 friends-bar"
					onclick="location.href='ViewSugFriendsProfile?friend_id=<s:property value='%{user.user_id}'/>'">
